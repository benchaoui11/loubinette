  ...
  return (
    <div className="space-y-5">
      ...
      <section className="panel rounded-2xl p-5">
        {data.applications.length ? <ApplicationsTable applications={data.applications} /> : <EmptyState title="No applications loaded" body="No application data is connected for this website selection." />}
      </section>
    </div>
  );
}
